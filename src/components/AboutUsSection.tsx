    ...
    <section className="container flex flex-col-reverse lg:flex-row items-start gap-[64px]">
      ...
      <article className="flex flex-col gap-8 max-lg:items-center text-center md:text-left">
        <div>
          ...
          <p className="md:hidden text-base text-secondary font-semibold uppercase text-greenFM">
        ...
        <div className="flex flex-col gap-10">
          <p className="text-grey text-base md:text-lg md:leading-7">
            Frontiers Market got its start in Texas with one goal: provide
            farmers and ranchers with digital solutions to help them become more
            efficient, profitable, and competitive in national markets.
          </p>
          <p className="text-grey text-base md:text-lg md:leading-7">
            Our team of ranchers and tech innovators is helping build a stronger
            future for agriculture, as a trusted partner of operations across
            the country.
          </p>
          <p className="text-grey text-base md:text-lg md:leading-7">
            We are driven by the belief that agriculture is the backbone of this
            country and without farmers and ranchers creating a secure and
            independent food supply, there is no United States.
          </p>
        </div>
        <img
          className="max-md:w-[230px] pt-2"

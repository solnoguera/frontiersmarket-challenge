    ...
    return (
      <section className="max-md:px-0">
        <div
          ...
          style={{ backgroundImage: 'url("assets/banner.webp")', backgroundSize: 'cover', backgroundPosition: 'center center' }}
        >
          ...
          <a className="bg-secondary text-white text-base md:text-lg font-bold rounded-lg py-4 px-11" href="/browse">
            Browse livestock
          </a>
        </div>
      </section>

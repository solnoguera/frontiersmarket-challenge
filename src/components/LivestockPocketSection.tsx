        ...
        <div className="z-10 relative bg-livestockFM grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 rounded-lg">
            <div className="row-start-2 md:row-start-1 flex flex-col justify-between gap-1 md:pt-28 md:pl-8 lg:pb-9 lg:pl-16">
                <div className="z-10 max-md:px-4 flex flex-col gap-2 text-primary">
                    ...
                    Weigh your livestock <br />with our free app
                    </h2>
                    <a
                ...
                <div className="rounded-b-lg flex items-center justify-center md:justify-start flex-row gap-2 bg-tertiary md:bg-transparent">
                    <img className="hidden lg:block" src="assets/ranchers.webp" alt="Ranchers" width="84" height="32" />
            ...
            <picture className="row-start-1 flex justify-center md:justify-end">
                <source className="rounded-lg" srcSet="assets/pocket_mobile.webp" type="image/webp" media="(max-width: 768px)" width="100%" />
                <source className="rounded-lg" srcSet="assets/pocket_desktop.webp" type="image/webp" width="522" height="470" />
                <source className="rounded-lg" media="(max-width: 768px)" srcSet="assets/pocket_mobile.webp" width="100%" />
                <img className="rounded-lg" src="assets/pocket_desktop.webp" alt="Phone" width="522" height="470" />
            </picture>

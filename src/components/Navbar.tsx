    ...
    <nav className="bg-[#FBFAFA] sticky top-0 z-30">
      <div className="sm:py-4 py-6 flex flex-row items-center md:items-end justify-between gap-16">
        <div className="hidden md:flex">
          <a href="/">
            <picture>
              <img src="assets/logo.svg" alt="Logo" width="100" height="32" className="hidden md:flex" />
            </picture>
          </a>
        </div>
        <button className="rounded-full bg-white p-2 flex md:hidden items-center md:flex">
          <div className="rounded-full bg-white h-8 w-8 flex items-center justify-center mr-2">
            <img src="assets/logo_small.svg" alt="Logo" className="h-6 w-6 flex md:hidden" />
          </div>
          <svg
        ...
        <div className="flex flex-1 flex-row items-center justify-end gap-3">
          ...
          <a className="hidden md:flex gap-2 text-primary text-base pr-3 items-center" href="tel:+15123874314 ">
            Call us
          ...
          <div className="flex gap-3">
            ...
            <a className="font-bold text-sm sm:text-base rounded-md py-2 px-3 bg-blueFM text-white hidden md:flex" href="/register">
              Register
            </a>
            {/* <Button title="Log In" />

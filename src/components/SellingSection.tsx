  ...
  return (
    <>
      <section className="container pt-6">
        <p className="text-center text-base text-secondary font-semibold uppercase text-greenFM">
        ...
        <section className="flex flex-col items-center py-6 md:py-8">
          <div className="flex gap-2 border border-slate-300 rounded-3xl p-1">
            <button
              type="button"
              className={`font-semibold text-sm lg:text-base px-4 py-2 rounded-3xl bg-secondary ${
                !buying ? 'bg-greenFM text-white' : 'text-textGreyFM'
              }`}
            ...
            <button
              type="button"
              className={`font-semibold text-sm lg:text-base px-4 py-2 rounded-3xl ${
                buying ? 'bg-greenFM text-white' : 'text-textGreyFM'
              }`}
            ...
            <div className="flex flex-1 justify-center md:justify-end">
              <picture>
                <source
                  srcSet={`${
                    buying
                      ? 'assets/d-buying-1.webp'
                      : 'assets/d-selling-1.webp'
                  }`}
                  type="image/webp"
                />
                <img
            ...
            <div className="flex flex-1 justify-center md:justify-end">
              <picture>
                <source
                  srcSet={`${
                    buying
                      ? 'assets/d-buying-2.webp'
                      : 'assets/d-selling-2.webp'
                  }`}
                  type="image/webp"
                />
                <img
            ...
            <div className="flex flex-1 justify-center md:justify-end">
              <picture>
                <source
                  srcSet={`${
                    buying
                      ? 'assets/d-buying-3.webp'
                      : 'assets/d-selling-3.webp'
                  }`}
                  type="image/webp"
                />
                <img
